...
<form class="mt-4 flex flex-column align-items-center" @submit.prevent="createCategory">
<div class="form-block">
    <label for="category">Категория</label>
    <input type="text" placeholder="Добавить категорию" v-model="category" class="basic-input" required id="category">
</div>

   <div class="mt-5 form-block">
    <label for="categoryKg">Категория (кырг)</label>
    <input type="text" placeholder="Добавить категорию" v-model="categoryKg" class="basic-input" required id="categoryKg">
   </div>
