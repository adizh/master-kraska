    ...
    <div class="main">
        ...
        <div class="grid form" v-else>
            <div class="col-12 each-field">
                ...
                <input class='col-12 basic-input' type="text" id="password" :placeholder="$t('newPassword')"
            ...
            <div class="col-12 each-field">
                ...
                <input class='col-12 basic-input' type="text" id="passwordRepeat" :placeholder="$t('repeatPassword')"
            ...
            <div class="change-password">
                <button @click="changePassword" class="register-auth-btn">{{ $t('reset') }}</button>
            </div>
        </div>
    </div>
