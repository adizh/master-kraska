    ...
    <div class="main">
        ...
        <div class="grid form" v-else>
            <div class="col-12 each-field password-block-input">
                ...
                <img src="../../assets/icons/black/ri_eye-off-line.svg" alt="close" v-else
                    @click="isOldPasswordOpen = true" class="password-icon">
            ...
            <div class="col-12 each-field password-block-input">
                ...
                <img src="../../assets/icons/black/ri_eye-off-line.svg" alt="close" v-else
                    @click="isPasswordOpen = true" class="password-icon">
            ...
            <div class="col-12 each-field password-block-input">
                ...
                <img src="../../assets/icons/black/ri-eye-open.svg" alt="open" v-if="isNewPasswordOpen"
                    @click="isNewPasswordOpen = false" class="password-icon">
                <img src="../../assets/icons/black/ri_eye-off-line.svg" alt="close" v-else
                    @click="isNewPasswordOpen = true" class="password-icon">
