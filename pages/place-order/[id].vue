  ...
  <section>
    ...
    <div class="orders grid">
      <div class="orders-first lg:col-8 md-col-12 col-12">
        ...
        <div v-if="selectedOrderPlacement === 1">
          <div class="magazine">
            <h3>{{ $t("chooseStore") }}</h3>
            <button
              class="gray-buttons-border mb-2"
              @click="isMagVisible = !isMagVisible"
            >
              {{ selectedMarket?.name }}
            </button>
          ...
          <span v-if="pickupErr.payMethod" class="err-input-msg">{{
            pickupErr.payMethod
          }}</span>
      ...
      <div class="cart-main-info-price lg:col-4 md:col-6 sm:col-12 col-12">
        ...
        <button class="margin-top-20 pink-button" @click="submitOrder">
          {{ $t("confirmOrder") }}
        </button>
      </div>
    </div>
    ...
    >
      <div class="warning-modal-exit">
        ...
        <div class="flex flex-row justify-content-end gap-2 buttons">
          <button class="modal-btns danger" @click="deleteOrder">
            {{ $t("logout") }}
          </button>
          <button class="modal-btns" @click="isWarningOpen = false">
            {{ $t("cancel") }}
          </button>
        </div>
      </div>
