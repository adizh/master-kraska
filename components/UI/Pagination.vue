        ...
        <nav class="pagination-container">
            <ul class="list-pagination">
                ...
                <div class="buttons-pgn">
                    ...
                    <button class="pagination-arrow next" :disabled="currentPage === totalPages.length"
                        @click="nextPage">
...
const ellipseShow = computed(() => {
    return visiblePages.value[visiblePages.value.length - 1] < totalPages.value.length;
});
